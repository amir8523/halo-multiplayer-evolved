...
cl /nologo /std:c++20 /EHsc /W4 /permissive- /utf-8 /MT /O2 /DNOMINMAX /DUNICODE /D_UNICODE /D_CRT_SECURE_NO_WARNINGS "%ROOT%tools\trigger\MPE_Trigger.cpp" /Fo"%OUT%\trig\\" /Fe"%OUT%\MPE_Trigger.exe" /link /SUBSYSTEM:CONSOLE
if errorlevel 1 ( echo BUILD FAILED & exit /b 1 )
echo === Built MPE_Trigger.exe ===
endlocal
